...
##### **Fig S9.** Predicted versus observed false discovery rate using actual generation distribution
...
```{r error_hist_mut_samplesize_spec, echo=FALSE, fig.width=7.5, fig.height=6, eval=FALSE}

##### **Fig SN** Error of sensitivity calculation using mutation rate method by sample size

rho = 0.1
col_breaks = c(0,0.25,0.5,0.75,1.0)*max_sim_size*rho
col_names = c("0-50","50-100","100-150","150-200")
err_hists_rho10 <- plot.error.hist.breaks(
  saved_data="data/full_data_mutrate.Rdata",rho=rho,col_break_by="M",col_breaks=col_breaks)
