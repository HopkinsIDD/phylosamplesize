...
lefttitle <- textGrob("Generation distribution: average", gp=gpar(fontsize=10,fontface="bold"))
righttitle <- textGrob("Generation distribution: actual", gp=gpar(fontsize=10,fontface="bold"))
grid.arrange(lefttitle,righttitle,
             p_mutrate_spec,p_gens_spec,
